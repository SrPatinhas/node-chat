...
(function($){
    $.fn.ttwSimpleNotifications = function(userOptions){
        ...
        function init(){
            var position, css = {position:'fixed'};
        ...
        function show(notificationOptions){
            if(typeof notificationOptions != 'undefined'){
                ...
                if(typeof notificationOptions == 'string'){
                    ...
                    setMessage($notification, notificationOptions.user, notificationOptions.msg);
        ...
        function setMessage($notification, user, msg){
                if(typeof msg != 'undefined')
                    $notification.find('.user').html(user);
        ...
        function hide(notificationId){
            if(typeof notifications[notificationId] != undefined){
                ...
                $(notifications[notificationId]['notification']).remove();
